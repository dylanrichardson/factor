...
void EXIT (void);
/*char RECENT_STRING[10][50];
char RECENT_INT[10][50];
char RECENT_FLOAT[10][50];
char RECENT_DOUBLE[10][50];
char RECENT_CHAR[10][2];*/
enum Options{
	PASSWORD = 1<<0,
	NO_AUTO_NEWLINE = 1<<1,
	BEEP = 1<<2,
...
enum Type{INT_,FLOAT_,STRING,BOOL_,DOUBLE_,CHAR_,INT_ARRAY};
